...
class ResourceIntegrationTest {
    ...
    void testFullResourceFlow() throws Exception {
        ...
        createDTO.setType(ResourceType.LABORATORY);
    ...
    void testCreateDifferentResourceTypes() throws Exception {
        ...
        classroomDTO.setType(ResourceType.CLASSROOM);
        ...
        labDTO.setType(ResourceType.LABORATORY);
        ...
        auditoriumDTO.setType(ResourceType.AUDITORIUM);
